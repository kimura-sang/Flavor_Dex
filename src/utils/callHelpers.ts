...
export const approveSpender = async (tokenContract, spenderContract, accountOwnerAddress) => {
  return tokenContract.methods
    .approve(spenderContract.options.address, ethers.constants.MaxUint256)
    .send({ from: accountOwnerAddress })
}


export const flavorsContribute = async (publicPresaleContract, amount, account) => {
  return publicPresaleContract.methods
    .contribute()
